...
function NeoMask:createVertical(config)
  local netvs = {}
...
function NeoMask:createHorizontal(config)
  local neths = {}
...
function NeoMask:refinement(neth,netv)
...
function NeoMask:createTopDownRefinement(config)
...
--------------------------------------------------------------------------------
-- function: forward
function NeoMask:forward(input)
  -- forward bottom-up
...
--------------------------------------------------------------------------------
-- function: backward
function NeoMask:backward(input,gradOutput)
...
function NeoMask:setnpinference(np)
